...
class GFDirectory_Admin {
	...
	function __construct() {
		...
		add_action('media_buttons_context', array(&$this, 'add_form_button'), 999);
...
#		}
	...
	public function admin_head($settings = array()) {
		...
		if(!empty($settings['modify_admin']['expand'])) {
			if(isset($_REQUEST['pagenum']) && $_REQUEST['page'] == 'gf_edit_forms' && isset($_REQUEST['id']) && is_numeric($_REQUEST['id'])) {
